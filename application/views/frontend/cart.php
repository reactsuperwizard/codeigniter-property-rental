...
<div class="body cart hidden" data-section="cart" style="padding: 0% 10% 10% 5%">
  ...
  <div class="listStep">
    <div class="list"></div>
    <div>
      <a class="btn btn-lg btn-primary pull-right" onclick="NS_Rental.cart.validateRequest();">Continue</a>
    </div>
  </div>
