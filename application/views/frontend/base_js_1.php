...
?>
  ...
  ,'bookings':{
    ...
    ,'templates':{
      'init':function(){
        if (this.initiated) return false;
        this['base']=document.querySelector('#NS_Rental .templates .booking').innerHTML;
        this['item']=document.querySelector('#NS_Rental .templates .bookingItem').innerHTML;
        this['service']=document.querySelector('#NS_Rental .templates .bookingService').innerHTML;
        this['initiated']=true;
      }
      ,'initiated':false
      /** /
